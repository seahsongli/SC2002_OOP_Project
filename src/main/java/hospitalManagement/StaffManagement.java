...
public class StaffManagement {
    ...
    public String capitalizeName(String name) {
        ...
        // StringBuilder allows in-place modifications, meaning no new objects are
        // created, which saves memory and improves performance.
    ...
    private List<Staff> filterByRole(List<Staff> staffList) {
        ...
        // wrong input by the user
            ...
            // String.join(", ", Roles.ALLOWED_ROLES) extracts the valid roles from
            // Roles.java seperated by comma and space
            System.out.println(
                    "Invalid role entered. Valid roles are: " + capitalizeName(String.join(", ", Roles.ALLOWED_ROLES)));
            System.out.print("\n");
            return null;
        }
    }
    ...
    public void viewStaffs(List<Staff> staffList) {
        ...
        for (Staff staff : staffList) {
            System.out.println("Staff ID: " + staff.getStaffId().toUpperCase() + "," + " Name: "
                    + capitalizeName(staff.getName()) + "," + " Role: " + capitalizeName(staff.getRole()) + ","
                    + " Gender: " + capitalizeName(staff.getGender()) + "," + " Age: " + staff.getAge());
        }
        System.out.print("\n");
    ...
    public void updateStaffDetails(String oldStaffId, String newStaffId, String name, String role, String gender,
        ...
        for (Staff staff : staffs) {
            if (staff.getStaffId().equalsIgnoreCase(oldStaffId)) {
                // detail(name, role, gender...) != null condition is important for example if
                // we choose to update only 2 out of 6 details then
                // rest of the details will be null, throwing a nullPointerException error
