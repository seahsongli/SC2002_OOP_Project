...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (choice == 1) {
                login(appointmentManagement, medicalRecordManagement, inventoryManagement, prescriptionManagement,
                        staffManagement);
            } else if (choice == 2) {
    ...
    private static void initializeUsers(StaffManagement staffManagement) {
        ...
        // Patient data: username, password, patientId, name, dob, gender, bloodtype,
        // email, phoneNumber
        ...
        for (int i = 0; i < staffData.length; i++) {
            ...
            int age = (data[6] instanceof Double) ? ((Double) data[6]).intValue()
                    : Integer.parseInt(data[6].toString());
        ...
        for (int i = 0; i < patientData.length; i++) {
            ...
            if (users.containsKey(hospitalId)) {
                ...
                // String hospitalID, String password, String patientId, String name, String
                // dob, String gender, String bloodGroup, String email
            ...
            // String patientId, String patientName, String dateOfBirth, String gender,
            // String bloodType, String contactNumber, String email, List<String>
            // pastDiagnosis, List<String> pastTreatments, List<String> currentDiagnosis,
            // List<String> currentTreatments, List<String> prescriptions
            MedicalRecord medicalRecord = new MedicalRecord(patientId, name, dob, gender, bloodGroup, contactNumber,
                    email);
    ...
    private static void login(AppointmentManagement appointmentManagement,
        ...
        if (user != null && user.checkPassword(password)) {
            ...
            if (password.equals("password")) {
                ...
                System.out.println();
                changePassword(user);
                navigateToMenu(user, appointmentManagement, medicalRecordManagement, inventoryManagement,
                        prescriptionManagement, staffManagement);
            } else {
                navigateToMenu(user, appointmentManagement, medicalRecordManagement, inventoryManagement,
                        prescriptionManagement, staffManagement);
            }
    ...
    private static void saveContext(MedicalRecordManagement medicalRecordManagement, StaffManagement staffManagement,
    ...
    private static void navigateToMenu(User user, AppointmentManagement appointmentManagement,
        ...
        switch (user.getRole()) {
            case "administrator":
                AdministratorMenu adminMenu = new AdministratorMenu(inventoryManagement, staffManagement,
                        appointmentManagement, users);
